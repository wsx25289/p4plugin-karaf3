...
public abstract class Utils {
    ...
    public static boolean setTofinoSwitchPipelineConfig(String node, String ip, Integer port, Long deviceId) {
        String runtimeInfo = "/home/opendaylight/p4lang/behavioral-model/targets/simple_switch_grpc/tests/testdata/packet_io.proto.txt";
        String deviceConfig = "/home/opendaylight/p4lang/behavioral-model/targets/simple_switch_grpc/tests/testdata/packet_io.json";
        try {
            P4Device device = new ResourceManager().getDevice(node, ip, port, deviceId, runtimeInfo, deviceConfig);
            return device.setPipelineConfig() != null;
        } catch (IOException e) {
            LOG.info("Cannot find runtimeInfo or deviceConfig, reason = {}.", e.getMessage());
        }
