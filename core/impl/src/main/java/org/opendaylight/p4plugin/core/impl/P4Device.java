...
import org.opendaylight.yang.gen.v1.urn.opendaylight.p4plugin.core.rev170808.WriteTableEntryInput;

import org.opendaylight.yang.gen.v1.urn.opendaylight.p4plugin.core.rev170808.action.definition.Params;
import org.opendaylight.yang.gen.v1.urn.opendaylight.p4plugin.core.rev170808.match.fields.definition.MatchFields;
import org.opendaylight.yang.gen.v1.urn.opendaylight.p4plugin.core.rev170808.match.fields.definition.match.fields.MatchType;
import org.opendaylight.yang.gen.v1.urn.opendaylight.p4plugin.core.rev170808.match.fields.definition.match.fields.match.type.*;
...
public class P4Device {
    ...
    public String getActionProfileId(Integer actionProfileId) {
        String result = null;
        Optional<ActionProfile> actionProfileContainer = runtimeInfo.getActionProfilesList().stream()
     ...
     */
    public TableEntry toMessage(WriteTableEntryInput input) {
        if (runtimeInfo == null) {
    ...
    public String actionProfileMemberToString(ActionProfileMember member) {
        ...
        List<org.opendaylight.p4plugin.p4runtime.proto.Action.Param> paramList = action.getParamsList();
        int actionId = action.getActionId();
        String actionProfile = getActionName(profileId);
        StringBuffer buffer = new StringBuffer();
